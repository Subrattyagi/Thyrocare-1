          ...
          {image ? (
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-medical-blue rounded-full flex items-center justify-center mx-auto mb-2">
                {/* Removed the letter inside the circle */}
              </div>
              {/* Removed the imageAlt text below the circle */}
            </div>
          )}
        </div>
          ...
          {description.length > 110 ? (
            <>
              ...
              <Button
                asChild
                variant="link"
                className="p-0 h-auto align-baseline text-medical-blue ml-1 text-xs font-medium"
              >
