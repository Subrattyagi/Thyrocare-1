...
export const HeroSection = () => {
  ...
  return (
    <section className="relative pt-4 pb-8 min-h-[600px] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              {bannerContent.title}
              <span className="text-medical-blue block -mt-8 mb-10 text-left pl-0 ml-0">{bannerContent.subtitle}</span>
            </h1>
